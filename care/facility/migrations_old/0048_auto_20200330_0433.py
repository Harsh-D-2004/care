        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.IntegerField(
                        auto_created=True, blank=True, db_index=True, verbose_name=_("ID")
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(verbose_name=_("Contact with a Covid19 carrier")),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True,
                        help_text=_("Not active when discharged, or removed from the watchlist"),
                    ),
                ),
